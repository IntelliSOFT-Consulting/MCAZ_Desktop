export const SAE_MANDATORY_FIELS  = [
  ...
  // { name : 'sae_type', text : "2a. If SAE, is it", page : 3, dependent : "adverse_event_type", value : "SAE"  },
  // { name : 'sae_description', text : "If Other, specify", page : 3, dependent : "sae_type", value : "Any other important medical event." },
  ...
  //{ name : 'previous_events_number', text : "If yes, how many?", page : 3, dependent : "previous_events", value : "Yes" },
  ...
  //{ name : 'location_event_specify', text : "If other, specify", page : 3, dependent : "location_event", value : "Other" },
  //{ name : 'research_involves', text : "5. Research involves a", page : 3 },
  //{ name : 'research_involves_specify', text : "If other, specify", page : 3, dependent : "research_involves", value : "Other" },
  ...
  /*{ name : "adr_other_drugs", fields: [{ name : "drug_name", text : "Name of drug" }, { name : "start_date", text : "Date started" },
    { name : "stop_date", text : "Date stopped" }, { name : "relationship_to_sae", text : "Relationship of SAE to medication" }], dependent : { name: "patient_other_drug", value: "Yes" }},*/
...
export const AEFI_MANDATORY_FIELS  = [
  ...
  //{ name: "name_of_vaccination_center", text: "Name of vaccination centre:" },
  ...
  { name : "designation_id", text : "Designation", page : 1 },
  { name : "description_of_reaction", text : "Describe AEFI (Signs and symptoms):", page : 3 },
