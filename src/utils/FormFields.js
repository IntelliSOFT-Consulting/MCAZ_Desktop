export const SAE_MANDATORY_FIELS  = [
  ...
  { name : "adr_list_of_drugs", fields: [{ name : "drug_name", text : "Drug/Device/Vaccine" }, { name: "dosage", text: "Dose"}, { name : "dose_id", text : "Dose" },
    ...
    { name : "taking_drug", text: "Taking drug at onset of SAE?" }, { name: "relationship_to_sae", text : 'Relationship of SAE to drug'}], dependent : { name: "patient_other_drug", value: "Yes" }},
