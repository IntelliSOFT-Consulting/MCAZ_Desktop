        ...
        <form className="form-horizontal">
          ...
          <div className="container">
            <div className="col-md-12 col-sm-12">
              <AgeAtOnSetInput label="OR Age at onset" inline={ true } name="age_at_onset" model={ model } options={ AGE_ON_ONSET } onChange={ (value) => this.validateAge(value) } onChange={this.onChange}/>
            </div>
          </div>
          <div className="container">
            <div className="col-md-6 col-sm-12">
          ...
          <div className="container">
            <div className="col-md-6 col-sm-12">
              <TextInput label="Department" name="reporter_department" model={ model } onChange={this.onChange}/>
            </div>
            <div className="col-md-6 col-sm-12">
              <TextInput label="Address" name="reporter_address" model={ model } onChange={this.onChange}/>
            </div>
          </div>
          <div className="container">
            <div className="col-md-6 col-sm-12">
              <TextInput label="District" name="reporter_district" model={ model } onChange={this.onChange}/>
            </div>
            <div className="col-md-6 col-sm-12">
          ...
          <div className="container">
            <div className="col-md-6 col-sm-12">
              <TextInput label="Reporter Telephone" name="reporter_phone" model={ model } onChange={this.onChange}/>
            </div>
            <div className="col-md-6 col-sm-12">
              <TextInput label="Reporter Email" name="reporter_email" model={ model } onChange={this.onChange}/>
            </div>
          </div>
          ...
          <div className="container">
            <div className="col-md-6 col-sm-12">
              <DatePickerInput label="Date and time AEFI started"  name="aefi_date" model={ model } showTime={ true } maxDate={ moment() } onChange={this.onChange}/>
            </div>
            <div className="col-md-6 col-sm-12">
              <SingleMultipleInput label="Was patient hospitalized?"  name="patient_hospitalization" model={ model } inline={ true } options={ BOOLEAN_OPTIONS } onChange={this.onChange}/>
            </div>
          </div>
          <div className="container">
            <div className="col-md-6 col-sm-6">
              <DatePickerInput label="Date patient notified event to health system" name="notification_date" model={ model } maxDate={ moment() } minDate={ this.state.model['aefi_date'] } onChange={this.onChange}/>
            </div>
            <div className="col-md-6 col-sm-12">
              <SingleMultipleInput label="Treatment provided"  name="treatment_provided" model={ model } options={ BOOLEAN_OPTIONS } inline={ true } onChange={this.onChange}/>
            </div>
          </div>
          <div className="container">
            <div className="col-md-12 col-sm-12">
          ...
          { model.outcome == 'Died' ? (
            <div className="container">
              <div className="col-md-6 col-sm-12">
                <DatePickerInput label="If died, date of death" name="died_date" model={ model } maxDate={ moment() } onChange={this.onChange}/>
              </div>
              <div className="col-md-6 col-sm-12">
                <SingleMultipleInput label="Autopsy done" name="autopsy" model={ model } options={ BOOLEAN_UNKNOWN_OPTIONS } inline={ true } onChange={this.onChange}/>
              </div>
            </div>
          ) : null
          }
          ...
          <div className="container">
            <div className="col-md-4 col-sm-12">
              <DatePickerInput label="Date report recieved at District level" name="district_receive_date" model={ model } maxDate={ moment() } onChange={this.onChange}/>
            </div>
            <div className="col-md-4 col-sm-12">
              <SingleMultipleInput label="Investigation needed?"  name="investigation_needed" model={ model } options={ BOOLEAN_OPTIONS } inline={ true } onChange={this.onChange}/>
            </div>
            <div className="col-md-4 col-sm-12">
              <DatePickerInput label="If yes, date investigation planned"  name="investigation_date" model={ model } minDate={ this.state.model['aefi_date'] } onChange={this.onChange}/>
            </div>
          </div>
          <h5 className="text-center">National level to complete:</h5>
          <div className="container">
            <div className="col-md-4 col-sm-12">
              <DatePickerInput label="Date report received at national level (DD/MM/YYYY):" name="national_receive_date" model={ model } maxDate={ moment() } onChange={this.onChange}/>
            </div>
            <div className="col-md-8 col-sm-12">
              <TextInput label="Comments" multiLine={ true } name="comments" model={ model } onChange={this.onChange}/>
            </div>
          </div>
